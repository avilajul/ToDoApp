                            ...
                            <tr v-for="categoria in arrayCategoria" :key="categoria.id" >
                                <td>
                                   ...
                                   <template v-if="categoria.condicion">
                                       <button class="btn btn-danger btn-sm" @click="desactivarCategoria(categoria.id)">
                                           <i class="icon-trash"></i>
                                       </button>                                       
                                   </template>
                                   <template v-else>
                                       <button class="btn btn-danger btn-sm" @click="activarCategoria(categoria.id)">
                ...
                switch (modelo) {
                    case "categoria":
                    {
                        switch (accion) {
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registar categoría';
                                this.nombre  ='';
                                this.descripcion = '';
                                this.tipoAccion = 1; 
                                break;
