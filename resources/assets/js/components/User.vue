                            ...
                            <tr v-for="persona in arrayPersona" :key="persona.id" >
                                <td>
                                   ...
                                   <template v-if="persona.condicion">
                                       <button class="btn btn-danger btn-sm" @click="desactivarUsuario(persona.id)">
                                           <i class="icon-trash"></i>
                                    </button>                                  
                                   </template>
                                   <template v-else>
                                       <button class="btn btn-danger btn-sm" @click="activarUsuario(persona.id)">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="num_documento" class="form-control" placeholder="Nombre del Cliente">                                    
                                </div>
                            </div>
                            <div class="form-group row">
